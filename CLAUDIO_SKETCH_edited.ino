...
float Celcius=0;
float Fahrenheit=0;
int relayFan = 8;//pin on fan
int relayHeater = 9;//pin on water heater
int relayAgitator= 10;//pin on agitator
...
digitalWrite(relayAgitator, HIGH);// THIS FUNCTION IS TO START 30MIN AGITATOR CYCLES
